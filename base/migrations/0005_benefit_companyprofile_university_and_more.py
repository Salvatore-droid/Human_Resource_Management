...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('HR', 'Human Resources'), ('IT', 'Information Technology'), ('FIN', 'Finance'), ('OPS', 'Operations'), ('MKT', 'Marketing'), ('SALES', 'Sales'), ('R&D', 'Research & Development')], default='HR', max_length=10),
        ),
        migrations.AddField(
            model_name='department',
            name='description',
        ...
        migrations.AlterField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='intern_additional_profile', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
